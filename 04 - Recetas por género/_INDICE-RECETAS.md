...
| [17](<./17 - Interoperabilidad con la web (HTML5).md>) | **Interoperabilidad con la web (HTML5)** | Media | Extensiones `.js`, prefijo `gmcallback_`, `localStorage`, `http_*` y CORS, qué NO puedes hacer en web | Antes de publicar en itch.io, GX.games o tu propia web |
...
| [28](<./28 - Juegos para móvil (táctil).md>) | **Juegos para móvil (táctil)** | Media | Orientación (`os_set_orientation_lock`), escalado y zonas seguras por porcentaje, joystick virtual, multi-touch, rendimiento y batería, sandbox `game_save_id`, sensores, pruebas en dispositivo | Cualquier juego para Android/iOS |
...
| [45](<./45 - Géneros sin receta propia - sigilo, horror, táctica, granja y idle.md>) | **Géneros sin receta propia** | Media | Por cada uno: convenciones, sus tres sistemas críticos y a qué receta apoyarse. Medidor de detección, tensión de audio, calendario y estaciones, curva exponencial y progreso offline | Sigilo, horror, granja/cozy, idle/incremental |
...
| [04](<./04 - RPG _ Action RPG.md>) | **RPG / Action RPG** | Media‑Avanzada | Stats, curvas de experiencia, inventario, equipamiento, diálogos, quests, save/load, tilemaps grandes | 7.º — primer juego con estado persistente real |
...
| [09](<./09 - Survival y crafting.md>) | **Survival / crafting** | Avanzada | Recolección, inventario por pila, recetas, necesidades, construcción, chunking | 11.º |
