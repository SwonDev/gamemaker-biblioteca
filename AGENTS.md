...
3. **Crea el proyecto**:
   ...
   *Blank Pixel Game* — ambas funcionan —, o crea el proyecto desde el IDE. Tabla completa de
   las 18, verificada una a una, y las otras ocho trampas que hacen fracasar a un agente hoy
   ...
   [`12 - Utilidades e integraciones/09 - Manual del agente de IA`](./12%20-%20Utilidades%20e%20integraciones/09%20-%20Manual%20del%20agente%20de%20IA%20-%20operar%20GameMaker%20con%20gm-cli.md#0--las-nueve-trampas-que-hacen-fracasar-a-un-agente-hoy)
